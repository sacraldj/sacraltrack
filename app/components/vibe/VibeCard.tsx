              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    maxHeight: 870,
                    background:
                      "linear-gradient(135deg, #1A1A2E 0%, #2A2151 100%)",
                  ...
                  <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                    ...
                    <div
                      ...
                      style={{
                        ...
                        right: "-20%",
                        background:
                          "linear-gradient(135deg, #20DDBB 0%, #3b82f6 100%)",
                      }}
                    />
                    ...
                    <div
                      ...
                      style={{
                        ...
                        left: "-10%",
                        background:
                          "linear-gradient(135deg, #8B5CF6 0%, #20DDBB 100%)",
                      }}
                    />
                    {/* Sound wave lines */}
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[#A6B1D0] flex items-center gap-1">
                      <span>
          ...
          >
            ...
            >
              ...
              <div className="p-3 md:p-4 border-b border-white/10 flex items-center justify-between bg-[#1A1A2E]/50 sticky top-0 z-10">
                <div className="flex items-center gap-2">
                  ...
                  <span className="bg-[#20DDBB]/20 text-[#20DDBB] text-xs px-2 py-0.5 rounded-full ml-2">
                    {formatNumber(
                      !commentsLoading && commentsList && commentsList.length
                        ? commentsList.length
              ...
              <div className="flex-1 overflow-y-auto p-3 md:p-4 space-y-3 md:space-y-4 min-h-[200px] md:min-h-[300px] overscroll-contain">
                {commentsLoading && !commentsLoadTimeout ? (
                  ...
                  commentsList.map((comment: any) => (
                    <div
                      key={comment.id}
                      className={`bg-[#1A1A2E]/80 p-3 rounded-xl border ${comment.isOptimistic ? "border-[#20DDBB]/30 bg-gradient-to-r from-[#20DDBB]/5 to-[#0F9E8E]/5" : "border-white/5"}`}
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="mt-2 text-sm text-gray-200 break-words">
                            {comment.text}
                          </p>
                        </div>
                      </div>
              ...
              <form
                ...
                className="p-3 md:p-4 border-t border-white/10 bg-[#1A1A2E]/50 sticky bottom-0 z-10"
              >
                ...
                {commentText && (
                  ...
                  >
                    ...
                    <span
                      className={`${commentText.length > 450 ? "text-amber-400" : "text-gray-400"}`}
                    >
