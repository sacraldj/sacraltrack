...
const PostUserSkeleton = () => (
  <motion.div
    ...
    className="relative p-0.5 rounded-2xl overflow-hidden w-full sm:max-w-[450px] mx-auto mb-6 group"
  >
    {/* Animated border gradient */}
    <div className="absolute inset-0 bg-gradient-to-br from-[#20DDBB]/20 via-purple-500/10 to-[#5D59FF]/20 rounded-2xl"></div>

    {/* Card content container */}
    <div className="relative bg-gradient-to-br from-[#24183d]/95 to-[#1E1432]/98 backdrop-blur-xl rounded-2xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
        ...
        >
          ...
          >
            <motion.button
              whileHover={{
                scale: 1.03,
                backgroundColor: "rgba(63, 45, 99, 0.3)",
              }}
              whileTap={{ scale: 0.97 }}
              onClick={onClose}
              disabled={isDeleting}
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            className="text-[#A6B1D0] text-center"
          >
            Dear artist, your release has been deleted. The changes will take
            effect after your profile page refreshes.
          </motion.p>
          ...
          <motion.button
            ...
            whileHover={{
              scale: 1.03,
              backgroundColor: "rgba(32, 221, 187, 0.2)",
            }}
            whileTap={{ scale: 0.97 }}
            onClick={onClose}
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-gray-400 truncate max-w-[140px] sm:max-w-[200px]">
                        {post?.trackname}
                      </p>
                    </div>
                  </div>
          ...
          >
            ...
            <div
              className={`absolute inset-0 transition-all duration-300 ${
                showStats ? "bg-black/80 backdrop-blur-md" : "bg-transparent"
              }`}
            />
                ...
                >
                  <div className="flex items-center gap-1 bg-gradient-to-r from-amber-200 to-yellow-400 text-black text-[10px] sm:text-xs px-1.5 sm:px-2 py-0.5 rounded-full font-medium backdrop-blur-sm">
                    ...
                    <span className="truncate max-w-[120px] sm:max-w-none">
                      Release • {formatReleaseDate(post?.created_at)}
                    </span>
                  </div>
